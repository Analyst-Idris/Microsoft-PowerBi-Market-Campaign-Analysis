...
This is a Power BI project on market campaign analysis for an imaginary organization called Onyx Global Company. The project aims to analyze the effectiveness of various marketing campaigns by exploring factors such as engagement metrics (impressions, likes, comments) and performance indicators (revenue, ROI) across different channels and regions. The goal is to identify key insights that can help optimize marketing strategies and improve campaign performance.

**__Disclaimer__:** All dataset and reports do not represent any company, institution of any state or country, but just a dummy dataset to demonstrate the capabilities of Power BI. 


# Problem Statement

Onyx Global Company is facing challenges in optimizing its marketing campaigns across various channels and regions. The company needs to understand which channels and campaigns are most effective in terms of both audience engagement and financial performance. The primary objective of this analysis is to identify key factors contributing to successful campaigns and provide actionable insights to develop more effective marketing strategies.
...
**3.	Relationship Establishment:** Relationships were created between the calendar table and other data tables based on their common date columns.
